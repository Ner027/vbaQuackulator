VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} AdvModeDarkTheme 
   Caption         =   "Quackulator"
   ClientHeight    =   7956
   ClientLeft      =   120
   ClientTop       =   468
   ClientWidth     =   5808
   OleObjectBlob   =   "AdvModeDarkTheme.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "AdvModeDarkTheme"
